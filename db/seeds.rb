...
dish1 = Dish.create(name: "Sesame chicken", image:"sesame-chicken.jpg" )
dish2 = Dish.create(name: "Beef broccoli", image: "beef-broccoli.jpg")
dish3 = Dish.create(name: "Shrimp with vegetable", image: "shrimp-vegetable.jpg")
dish4 = Dish.create(name: "Scallop with garlic saurce", image: "scallop-garlic-saurce.jpg" )
dish5 = Dish.create(name: "Kung pao chicken", image: "kung-pao-chicken.jpg")
dish6 = Dish.create(name: "Combination lo mein ", image: "combination-lo-mein.jpg")
dish7 = Dish.create(name: "Combination chow mein", image: "combination-chow-mein.jpg")
dish8 = Dish.create(name: "Happy family", image:"happy-family.jpg" )
dish9 = Dish.create(name: "Live Lobster with ginger sauce", image: "lobster-ginger-saurce.jpg")
dish10 = Dish.create(name: "Steam whole fish", image: "steam-whole-fish.jpg")
...
order1 = Order.create(date: DateTime.new(2001,3,5), user_id: user1.id)
order2 = Order.create(date:DateTime.new(2002,3,5), user_id: user2.id)
